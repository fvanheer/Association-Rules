...
#import data
data_import = pd.read_csv('upload.csv', encoding='ISO-8859-1')
...
st.subheader('Count Products %i' % count)
st.subheader('Average times in basket together %i' % freq_Ave)
